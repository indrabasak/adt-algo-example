...
public class NewHeap<AnyType extends Comparable<AnyType>> {
    ...
    public static void main(String[] args) {
        NewHeap<String> h = new NewHeap<String>();
        ...
        NewHeap<Integer> tmp = new NewHeap<Integer>();
